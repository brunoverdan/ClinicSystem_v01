                ...
                {{$respostas}}
                    ...
                    <div class="form-group mb-4">
                        ...
                        @if($pergunta->modelo == 'modelo_01')
                            <div class="mb-2">
                                <textarea type="text" name="perguntas[{{ $pergunta->id }}][resposta]" class="form-control" rows="3" placeholder="Especifique se necessário">{{ $respostas->get($pergunta->id)->resposta ?? '' }}</textarea>
                        ...
                        @elseif($pergunta->modelo == 'modelo_02')
                            <div class="mb-2">
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="perguntas[{{ $pergunta->id }}][resposta]" value="sim" class="form-check-input" {{ ($respostas->get($pergunta->id)->resposta ?? '') == 'sim' ? 'checked' : '' }}>
                                    <input type="hidden" name="perguntas[{{ $pergunta->id }}][tipo_modelo]" value="modelo_02">
                                    <label class="form-check-label">Sim</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="perguntas[{{ $pergunta->id }}][resposta]" value="nao" class="form-check-input" {{ ($respostas->get($pergunta->id)->resposta ?? '') == 'nao' ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="perguntas[{{ $pergunta->id }}][quais]" class="form-control" placeholder="Especifique se necessário" value="{{ $respostas->get($pergunta->id)->quais ?? '' }}">
                                <input type="hidden" name="perguntas[{{ $pergunta->id }}][tipo_modelo]" value="modelo_02">
                            </div>
